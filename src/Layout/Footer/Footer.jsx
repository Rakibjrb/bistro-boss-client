  ...
  return (
    <div>
      <div className="footer gap-0 text-neutral-content">
        <aside className="bg-[#1F2937] w-full h-full flex justify-center py-24 items-center">
          <div>
            <svg
              width="50"
              height="50"
        ...
        <nav className="bg-[#111827] w-full h-full flex justify-center py-24 items-center">
          <div>
            <header className="text-white text-center text-2xl">
              Follow us
            </header>
            <p className="pt-4 pb-6">Join us on social media</p>
